				...
				{data.map((item: any, index: number) => {
					...
					return (
						<div
							...
							className='bg-white rounded-lg shadow-[#4bafeb] shadow-md hover:shadow-lg hover:shadow-[#4bafeb] transition-shadow cursor-pointer text-black flex flex-col m-5'>
